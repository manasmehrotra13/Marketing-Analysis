...
SELECT 
    ...
    UPPER(replace(REPLACE(ContentType, 'Socialmedia', 'Social Media'),'newsletter','News Letter')) AS ContentType,  -- Replaces "Socialmedia" with "Social Media" and then converts all ContentType values to uppercase
